...
#define SEARCH_USR_ONLINE "exist and online"
#define SEARCH_USR_OFFLINE "exist but offline"
...
enum ENUM_MSG_TYPE{
    ...
    ENUM_MSG_TYPE_UPDATE_FILE_REQUEST, //上传文件夹请求
    ENUM_MSG_TYPE_UPDATE_FILE_RESPOND, //上传文件夹回复
